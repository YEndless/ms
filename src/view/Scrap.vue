  ...
  <div>
    <el-row :gutter="20" id="el">
      ...
      <el-col :span="6">
        ...
        <el-button type="primary" round style="text-align: center" @click="pur">新增报废</el-button>
      </el-col>
    </el-row>
    <el-table
  ...
  export default {
    ...
    methods:{
      ...
      getAll(){
        var that = this
        this.$axios
          .get(this.$setting.ApiRoot+'/scrap/all')
      ...
      handleDelete(index, row) {
        ...
        this.$confirm('即将删除',
          '提示',
          {
            ...
            this.$axios
              .delete(this.$setting.ApiRoot +'/scrap/delete', {
                  params:
                    {
                      id:row.id
                    }
